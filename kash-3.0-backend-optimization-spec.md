...
- **D2 — Desktop sync visibility → _status dot + detail panel._** A synced/syncing/offline dot, expandable to last-synced time, pending count, manual sync, recent conflicts. Most transparent option; lands as OPT-7. **Placement resolved Jul 1 2026:** detail panel **expands from the sidebar footer dot** (AN-B8 dot is always-visible; panel is the D2 expansion).
...
- ~~D2 panel placement~~ — **resolved Jul 1 2026:** detail panel expands from **sidebar footer dot** (§4 Nav / §15).
