...
- **Not yet built (no tables / shells):** abyss, care/wellbeing/garden, goals, values/about-me, planning-mode bingo/goals tables. `/abyss` and `/care` remain shells.

**Implication:** the **data spine is complete**; Week §7 still needs polish (load/tally/review/AI). The **net-new feature surfaces** (Abyss, Planning Mode, Values, Care, AI persona refactor) are **spec'd but unbuilt.**
