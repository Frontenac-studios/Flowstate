...
| 2     | Time-tracking on any task  | ✅ spec'd (2A–2E)                                                            | ⬛ **built** — `task_time_entries`, `weeklyRollup`, `aggregate-week.ts`, `WeeklySummaryCard`, weighted progress in projects router.                                                                                                                                                                                                                                                                                                                                       |
...
| 5     | Task tags (§14)            | ✅ spec'd (5A–5E) below                                                      | ⬛ **built** — `tasks.tags` jsonb column, composer `;tag` capture, Week tag filter, task-detail chips, sync parity (`0029` migration). Cross-ref: `planning-mode.md` §13.7 (not a planning-tab feature).                                                                                                                                                                                                                                                                  |

> **Re-baselined Jul 1 2026** against `main` (Phases 0–6): Phases 1–4 + Week protected blocks + **task tags** are **built**. Active tail: backend optimization parallel track + gap-audit reassurance tracks.
