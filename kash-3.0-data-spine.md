...
- **1.4 Loose-task capture** — is category **required** at creation for project-less tasks, or does it default to something? What's the default if required-but-unset?
...
| 3.1–3.2 | Dependencies schema/cycles | `task_dependencies` (blocker/blocked, same-project); cycle prevention in app layer                                                                                                                                                                    | Jun 16 |
| 3.3     | Blocked-task behavior      | **Hide** blocked task until unblocked; **boost the blocking task's RDM weight** so it surfaces sooner                                                                                                                                                 | Jun 16 |
