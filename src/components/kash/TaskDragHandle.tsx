...
export const TaskDragHandle = forwardRef<HTMLButtonElement, Props>(function TaskDragHandle(
  ...
  return (
    <button
      ref={ref}
      type="button"
      className={`text-kash-ink-muted/25 hover:text-kash-ink-muted/50 mt-0.5 flex h-3 w-2.5 shrink-0 cursor-grab items-center justify-center active:cursor-grabbing ${
