...
export function ChatRail() {
  ...
  return (
    <>
      ...
      />
      <aside
        className="lg:top-shell fixed inset-y-3 right-3 z-modal flex w-[min(100%-1.5rem,var(--chat-rail-width))] flex-col rounded-card border border-border bg-surface p-card-x shadow-overlay lg:sticky lg:inset-auto lg:z-auto lg:h-[calc(100vh-var(--shell-pad-y)*2)] lg:w-[min(100%,var(--chat-rail-width))] lg:shrink-0"
