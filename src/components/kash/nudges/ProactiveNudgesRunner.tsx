...
function ActiveNudges() {
  ...
  return (
    <div
      className="pointer-events-none fixed bottom-[calc(var(--space-6)+var(--mobile-nav-clearance))] left-[calc(var(--space-6)+4.5rem)] z-overlay flex max-w-md flex-col gap-[var(--space-2)] lg:bottom-[var(--space-6)] lg:left-[calc(var(--space-10)+4.5rem)]"
      aria-live="polite"
    >
