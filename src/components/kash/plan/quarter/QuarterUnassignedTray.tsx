...
export default function QuarterUnassignedTray({ goals, selectedGoalId, onSelectGoal }: Props) {
  if (goals.length === 0) return null;

  return (
    <div className="flex flex-col gap-2">
      <p className="text-caption text-ink-muted">
        Unassigned goals — drag onto a month or tap a goal then tap a month
      </p>
