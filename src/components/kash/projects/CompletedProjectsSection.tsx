          ...
          <li key={project.id}>
            ...
            >
              <Link
                ...
                className="kash-focus-visible flex min-h-[var(--row-min-height)] items-center gap-2 rounded-card border border-border bg-surface px-3 py-[var(--row-py)] text-sm text-ink-muted shadow-surface outline-none transition hover:bg-surface-2"
              >
                <span
