...
import { LeftNavRail } from "@/components/kash/LeftNavRail";
...
export default function ProjectsLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[110rem] flex-1 gap-6 px-4 py-6 sm:px-6 lg:px-10">
        <LeftNavRail />
