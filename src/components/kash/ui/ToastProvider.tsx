  ...
  return (
    <ToastContext.Provider value={value}>
      ...
      {mounted
        ? createPortal(
            <div
              className="pointer-events-none fixed inset-x-0 bottom-[calc(var(--space-5)+var(--mobile-nav-height)+env(safe-area-inset-bottom))] z-toast flex flex-col items-center gap-[var(--space-2)] px-[var(--space-4)] lg:bottom-[var(--space-5)]"
              aria-live="polite"
            >
              {toasts.map((t) => (
